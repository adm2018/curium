...
The Curium Core GUI can be easily translated into other languages. Here's how we
...
is used to update curium_en.ts. This process has been automated, from src/,
simply run:
    make translate
