...
##perform gitian builds
 ...
 Build curiumd and curium-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit curium=v${VERSION} ../curium/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../curium/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	...
	popd
    ./bin/gbuild --commit curium=v${VERSION} ../curium/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
