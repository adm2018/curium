...
* Update translations, see [translation_process.md](https://github.com/curium/curium/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/curium/gitian.sigs.git
	git clone https://github.com/curium/curium-detached-sigs.git
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [curium-detached-sigs](https://github.com/curium/curium-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Update title of #curium on Freenode IRC

  - Optionally reddit /r/Curium, ... but this will usually sort out itself
