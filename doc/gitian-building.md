...
- [Building Curium](#building-curium-core)
...
in the Curium repository under 'Fetch and build inputs' to install sources which require
...
To build Curium (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Curium repository.
