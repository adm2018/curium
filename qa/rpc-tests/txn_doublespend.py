...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 CURIUM:
...
=======
        # First: use raw transaction API to send 12400 CURIUM to node1_address,
        # but don't broadcast:
...
=======
        # Create two spends using 1 500 CURIUM coin each
...
<<<<<<< HEAD
        # Node0's balance should be starting balance, plus 500 CURIUM for another
        # matured block, minus 12460, minus 20, and minus transaction fees:
        expected = starting_balance
=======
        # Node0's balance should be starting balance, plus 500CURIUM for another
...
<<<<<<< HEAD
        # Node0's total balance should be starting balance, plus 1000 CURIUM for 
...
=======
        # Node0's total balance should be starting balance, plus 1000CURIUM for
