...
>>>>>>> dev-1.12.1.0:src/wallet/rpcwallet.cpp
    if (wtx.IsCoinBase())
...
<<<<<<< HEAD:src/rpcwallet.cpp
            ...
            "\nArguments:\n"
            "1. amount         (numeric, required) The transaction fee in CURIUM/kB rounded to the nearest 0.00000001\n"
            "\nResult\n"
...

{
    ...
    return "Wallet encrypted; Curium Core server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.";
