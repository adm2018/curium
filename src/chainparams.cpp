...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Curium: 1 day
        ...
        vSeeds.push_back(CDNSSeedData("curium.org", "dnsseed.curium.org"));
        vSeeds.push_back(CDNSSeedData("curiumdot.io", "dnsseed.curiumdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("curium.io", "dnsseed.curium.io"));
