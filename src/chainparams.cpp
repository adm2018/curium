...
public:
    CMainParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10 * 30; // Dash: 5 minutes
        nTargetSpacing = 1 * 60; // Dash: 1 minutes
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of( 28);                    // Dash addresses start with 'X'
...
public:
    CTestNetParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10 * 30; // Dash: 1 day
