...
<<<<<<< HEAD
    ...
    { "curium",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "curium",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "curium",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "curium",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "curium",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "curium",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "curium",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "curium",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
