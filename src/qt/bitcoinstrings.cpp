...
QT_TRANSLATE_NOOP("curium-core", "Find peers using DNS lookup (default: 1 unless -connect)"),
...
QT_TRANSLATE_NOOP("curium-core", "Unable to bind to %s on this computer (bind returned error %d, %s)"),
