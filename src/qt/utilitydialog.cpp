    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Curium") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Curium"));
...
These denominations are 0.1 CURIUM, 1 CURIUM, 10 CURIUM, and 100 CURIUM--sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Curium is shutting down...") + "<br /><br />" +
