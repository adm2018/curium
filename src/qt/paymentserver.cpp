...
const char* BITCOIN_REQUEST_MIMETYPE = "application/curium-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/curium-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/curium-payment";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // curium: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
                ...
                emit message(tr("URI handling"),
                    tr("URI can not be parsed! This can be caused by an invalid Curium address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
